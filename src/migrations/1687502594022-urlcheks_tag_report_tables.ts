...
export class urlcheksTagReportTables1687502594022 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      ...
      CREATE TRIGGER update_tag_modtime BEFORE UPDATE ON "tag" FOR EACH ROW EXECUTE PROCEDURE update_modified_column();`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TRIGGER update_tag_modtime ON "tag"`);
